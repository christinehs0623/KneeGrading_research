...
python inference_k_fold.py \
  --current_ckpt model_checkpoints_20260131_093333_epoch200_MIL_MultiTask_imedslab_LCEoM_MA_C0_Fo_lr1e-04_b16 \
  --seed 42 \
  --inference_targe avg \
  --model_type MIL_MultiTask_imedslab \
  --lossfcn_type CrossEntropy_MultiTask \
...
python inference.py \
  --current_ckpt model_checkpoints_20260201_230548_epoch200_MIL_MultiTask_imedslab_LCEoM_MA_C0_Fo_lr1e-04_b16 \
  --seed 42 \
  --inference_targe avg \
  --model_type MIL_MultiTask_imedslab \
  --lossfcn_type CrossEntropy_MultiTask \
...
python inference.py \
  --current_ckpt model_checkpoints_20260130_015344_epoch200_MIL_LCE_M0_C0_Fo_lr1e-04_b16 \
  --seed 42 \
  --inference_targe kl \
  --model_type MIL \
  --lossfcn_type CrossEntropy \
...
# 測看看five fold的fold 1 bootstrap結果
python inference.py \
  --current_ckpt model_checkpoints_20260131_093333_epoch200_MIL_MultiTask_imedslab_LCEoM_MA_C0_Fo_lr1e-04_b16_GOOD \
  --seed 42 \
  --inference_targe avg \
  --model_type MIL_MultiTask_imedslab \
  --lossfcn_type CrossEntropy_MultiTask \
...
python inference.py \
  --current_ckpt model_checkpoints_20260202_041848_epoch200_MIL_MultiTask_imedslab_LCEoM_MA_C0_Fo_lr1e-04_b16 \
  --seed 42 \
  --inference_targe avg \
  --model_type MIL_MultiTask_imedslab \
  --lossfcn_type CrossEntropy_MultiTask \
...
python train_k_fold.py \
  ...
  --feedback_type off \
  --feedback_cam off \
  --note mean_aggregation_k_fold_42

python inference_k_fold.py \
  --current_ckpt model_checkpoints_20260209_034441_epoch200_MIL_LCE_M0_C0_Fo_lr1e-04_b16\
  --seed 42 \
  --inference_targe avg \
  --model_type MIL \
  --lossfcn_type CrossEntropy \
