...
from inference import run_epoch, bootstrap_evaluation, Config
...
def main(config):
    ...
    # selected_patient_ids = ["9959640_R", "9156526_R", "9008884_R", "9014209_R", "9016403_R", "9055836_R", "9690658_R", "9547360_R", "9528647_R", "9833887_R","9517311_R", "9519310_R", "9813958_R"]
    selected_patient_ids = [
        "9959640_R",  # KL 0

        "9156526_R",  # KL 1, JSNM 1
        "9547360_R",  # KL 1, JSNL 1

        "9008884_R",  # KL 2, JSNM 1
        "9528647_R",  # KL 2, JSNL 1

        "9014209_R",  # KL 3, JSNM 2
        "9517311_R",  # KL 3, JSNL 2

        "9055836_R",  # KL 4, JSNM 3
        "9813958_R",  # KL 4, JSNL
    ]
    for vis_patient in selected_patient_ids: # all patients
    # for vis_patient in test_pids:  # test patients
        # target_id = vis_patient("_")[0]
        # target_side = vis_patient("_")[1]

        parts = vis_patient.split("_")
        target_id = parts[0]    # 取得 "9001234"
        target_side = parts[1]  # 取得 "R"
    ...
    # 這邊應該是給蒐集好所有的data的處理
        ...
        #     index_all=index_all,
        #     side=target_side,  # "L" or "R"
        #     file_path_template="./original_data/V00/Bilateral_PA_Fixed_Flexion_Knee/{patient_id}.dcm",
